...
public class SecondHandMarketFragment extends BaseFragment implements OnPageChangeListener,OnClickListener{
	...
	public static BaseFragment newInstance(){
		BaseFragment baseFragment = new SecondHandMarketFragment();
		return baseFragment;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		contentView = inflater.inflate(R.layout.fragment_second_hand, null);
