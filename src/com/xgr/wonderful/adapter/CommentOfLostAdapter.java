...
public class CommentOfLostAdapter extends BaseContentAdapter<CommentForLost>{

	public CommentOfLostAdapter(Context context, List<CommentForLost> list) {
		super(context, list);
	...
	public View getConvertView(int position, View convertView, ViewGroup parent) {
		...
		final CommentForLost comment = dataList.get(position);
